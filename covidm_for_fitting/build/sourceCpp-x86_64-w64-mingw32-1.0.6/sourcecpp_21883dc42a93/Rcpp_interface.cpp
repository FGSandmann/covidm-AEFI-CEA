...
Rcpp::List cm_backend_simulate_v2(Rcpp::List parameters, unsigned int n_run, unsigned long int seed, unsigned int n_threads, string file_out);
RcppExport SEXP sourceCpp_46_cm_backend_simulate_v2(SEXP parametersSEXP, SEXP n_runSEXP, SEXP seedSEXP, SEXP n_threadsSEXP, SEXP file_outSEXP) {
BEGIN_RCPP
    ...
    rcpp_result_gen = Rcpp::wrap(cm_backend_simulate_v2(parameters, n_run, seed, n_threads, file_out));
    return rcpp_result_gen;
END_RCPP
}
// cm_evaluate_distribution_v2
Rcpp::DataFrame cm_evaluate_distribution_v2(string dist_code, unsigned int steps, double xmin, double xmax);
RcppExport SEXP sourceCpp_46_cm_evaluate_distribution_v2(SEXP dist_codeSEXP, SEXP stepsSEXP, SEXP xminSEXP, SEXP xmaxSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
...
RcppExport SEXP sourceCpp_46_cm_backend_mcmc_test(SEXP R_base_parametersSEXP, SEXP params_priorsSEXP, SEXP seedSEXP, SEXP burn_inSEXP, SEXP iterationsSEXP, SEXP n_threadsSEXP, SEXP classic_gammaSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
...
RcppExport SEXP sourceCpp_46_cm_backend_optimize_test(SEXP R_base_parametersSEXP, SEXP params_priorsSEXP, SEXP maxevalSEXP, SEXP ftol_absSEXP, SEXP seedSEXP, SEXP n_threadsSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< Rcpp::List >::type R_base_parameters(R_base_parametersSEXP);
...
Rcpp::List cm_backend_sample_fit_test(Rcpp::List R_base_parameters, Rcpp::DataFrame posterior, unsigned int n, unsigned long int seed);
RcppExport SEXP sourceCpp_46_cm_backend_sample_fit_test(SEXP R_base_parametersSEXP, SEXP posteriorSEXP, SEXP nSEXP, SEXP seedSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< Rcpp::List >::type R_base_parameters(R_base_parametersSEXP);
